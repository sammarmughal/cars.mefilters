          ...
          <div className="flex sm:flex-col flex-row fleax-wrap ">
            <h1 className="md:text-4xl  sm:text-2xl text-sm font-bold">
              ...
              <span className="md:text-4xl sm:text-3xl text-sm">
                Vintage Beauty - Classic Cars Collection{" "}
              </span>
            </h1>
          </div>
          <p className="md:text-sm text-xs md:font-medium font-normal py-2">
            {" "}
            Welcome users to explore a curated selection of timeless classic
            cars that embody automotive heritage and elegance.{" "}
          </p>
          <div className="flex flex-row sm:mt-6">
            <button className="save-btn btn-text flex items-center sm:rounded-xl">
              Discover Now{" "}
              <MdOutlineFindReplace className="sm:w-6 sm:h-6 h-5 w-5 ml-2" />
            </button>
          </div>
        </div>
      </section>
      <section className="bg-sky-100">
        <div className=" max-w-[1800px] mx-auto">
          <a
            ...
            className="flex justify-center mx-auto w-2/3 py-5 cursor-pointer"
            target="_blank"
          ...
          <div className="flex justify-center  py-5">
            <Link
              to="/cars"
              className="px-4 py-2 btn-text rounded-lg bg-gradient-blue"
            >
              View More
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-6 my-6 sm:grid-col-4">
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              {" "}
              <img src={Changan} className="object-contain" />
            </Link>
          </div>
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
          ...
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-5 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              <img src={FAW} className="object-contain" />
            </Link>
          </div>
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              <img src={Chevrolet} className="object-contain" />
            </Link>
          </div>
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              <img src={Daewoo} className="object-contain" />
            </Link>
          </div>
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              <img src={Daihatsu} className="object-contain" />
            </Link>
          </div>
          <div className="bg-white flex items-center justify-center w-full rounded-xl p-3 shadow-xl hover:shadow-inner">
            <Link to="/brands-internal">
              <img src={Add} className="object-contain" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="flex sm:flex-row flex-col gap-5">
          <div className="flex flex-col 2xl:mt-20 mt-4 gap-6 lg:w-[60%]">
            <div className="flex flex-col justify-center items-center mx-auto">
              ...
              <p className="text-center text-blue-800 py-2 w-1/2">
                Buyers can often personalize their new cars, choosing colors,
                trims, and optional features to suit their preferences and
                lifestyle.
              </p>
            </div>
            <div className="flex flex-col justify-center items-center mx-auto">
              ...
              <p className="text-center text-blue-800 py-2 w-1/2">
                Sellers on cars.me benefit from professional marketing tools,
                presenting their vehicles in the best light with high-quality
            ...
            <div className="flex flex-col justify-center items-center mx-auto">
              ...
              <p className="text-center text-blue-800 py-2 w-1/2">
                Customers receive dedicated guidance and support throughout
                their car-buying journey. Our team is committed to assisting
                with inquiries, providing expert advice, and ensuring a seamless
                experience.
              </p>
            </div>
          </div>
          <div className="mt-20 w-full  lg:block hidden w-[60%]">
            <img
              src={chooseus_car}
              className="w-full flex-justify-center mx-auto object-contain"
              style={{ maxHeight: "1394px", maxWidth: "870px" }}
            />
          </div>
          <div className="flex flex-col 2xl:mt-20 mt-4 gap-6 lg:w-[60%]">
            <div className="flex flex-col justify-center items-center mx-auto">
            ...
            <div className="flex flex-col justify-center items-center mx-auto">
              ...
              <p className="text-center text-blue-800 py-2 w-1/2">
                Security is a top priority at cars.me. Our platform employs
                robust security measures to ensure a safe and trustworthy
            ...
            <div className="flex flex-col justify-center items-center mx-auto">
              ...
              <p className="text-center text-blue-800 py-2 w-1/2">
                Cars.me incorporates innovative features, such as advanced
                search options, real-time market insights, and user-friendly
                interfaces, enhancing the overall experience for both buyers and
                sellers.
              </p>
            </div>
          </div>
